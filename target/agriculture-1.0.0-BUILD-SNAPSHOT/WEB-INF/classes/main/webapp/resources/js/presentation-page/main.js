...
(function () {
    var t, e, n, r, o, i, s, a, u, l, f, h, p, c, m, d, g, y, v, b, w, x, M, S, k, T, C, H, R, q, X, I, Y, j, z, F, G,
        A, O, V, Z, E, L, D, P, W, N, $, B, U, K, J, Q, _, te, ee, ne, re = function (t, e) {
            return function () {
    ...
    q = function () {
        ...
        var e, n, r, o, i, s, a, u;
        r = {};
        for (o in t) if (i = t[o], te.contains(o)) if (n = o.match(/(translate|rotateC|rotate|skew|scale|perspective)(X|Y|Z|)/), n && n[2].length > 0) r[o] = i; else for (u = ["X", "Y", "Z"], s = 0, a = u.length; a > s; s++) e = u[s], r[n[1] + e] = i; else r[o] = i;
        return r
    }, k = function (t) {
        var e;
        ...
        return t.prototype.interpolate = function (e, n) {
            ...
            for (e = "" + e, s = [], f = [{
                ...
                klass: i,
                parse: parseFloat
            }], h = 0, c = f.length; c > h; h++) for (l = f[h], u = l.re; r = u.exec(e);) s.push({
                index: r.index,
                length: r[1].length,
        ...
        return t.prototype.interpolate = function (e, n) {
            ...
            for (i = {}, p = ["translate", "scale", "rotate"], s = 0, f = p.length; f > s; s++) for (o = p[s], i[o] = [], r = a = 0, c = this.props[o].length; c >= 0 ? c > a : a > c; r = c >= 0 ? ++a : --a) i[o][r] = (e.props[o][r] - this.props[o][r]) * n + this.props[o][r];
        ...
        return t.prototype.interpolate = function (e, n, r) {
            ...
            for (null == r && (r = null), s = this, i = new t, w = ["translate", "scale", "skew", "perspective"], d = 0, b = w.length; b > d; d++) for (f = w[d], i[f] = [], a = g = 0, x = s[f].length - 1; x >= 0 ? x >= g : g >= x; a = x >= 0 ? ++g : --g) i[f][a] = null == r || r.indexOf(f) > -1 || r.indexOf("" + f + ["x", "y", "z"][a]) > -1 ? (e[f][a] - s[f][a]) * n + s[f][a] : s[f][a];
            ...
            for (i = t.quaternion, f = i[0], h = i[1], p = i[2], l = i[3], s = t.skew, r = [[1, 0], [2, 0], [2, 1]], e = m = 2; m >= 0; e = --m) s[e] && (a = u.I(4), a.els[r[e][0]][r[e][1]] = s[e], o = o.multiply(a));
        ...
        return t.prototype.e = function (t, e) {
            ...
            for (c = e.modulus ? !0 : !1, n = e.els || e, "undefined" == typeof n[0][0] && (n = new t(n).els), h = this.els.length, u = h, l = n[0].length, o = this.els[0].length, i = [], h += 1; --h;) for (s = u - h, i[s] = [], p = l, p += 1; --p;) {
            ...
            var e, n, r, o, i, s, a;
            for (a = this.els.length, e = this.els[0].length, n = [], i = e, i += 1; --i;) for (r = e - i, n[r] = [], s = a, s += 1; --s;) o = a - s, n[r][o] = this.els[o][r];
            return new t(n)
            ...
            for (t = this.dup(), a = this.els.length, o = a, i = this.els[0].length; --a;) {
                if (n = o - a, 0 === t.els[n][n]) for (r = f = p = n + 1; o >= p ? o > f : f > o; r = o >= p ? ++f : --f) if (0 !== t.els[r][n]) {
                    for (e = [], u = i, u += 1; --u;) l = i - u, e.push(t.els[n][l] + t.els[r][l]);
                    t.els[n] = e;
                    break
                }
                if (0 !== t.els[n][n]) for (r = h = c = n + 1; o >= c ? o > h : h > o; r = o >= c ? ++h : --h) {
            ...
            for (l += 1; --l;) for (i = a - l, f = u, f += 1; --f;) s = u - f, r.els[i][o + s] = n[i][s];
            return r
            ...
            var n, r, o, i, s;
            for (n = [], i = e, e += 1; --e;) for (r = i - e, n[r] = [], s = i, s += 1; --s;) o = i - s, n[r][o] = r === o ? 1 : 0;
            return new t(n)
        }, t.prototype.decompose = function () {
            var t, n, r, o, i, s, a, u, l, f, p, c, m, d, g, y, v, b, w, x, M, S, k, T, C, H, R, q, X, I, Y, j, z, F, G,
                A, O, V;
            for (s = this, x = [], v = [], b = [], f = [], u = [], t = [], n = X = 0; 3 >= X; n = ++X) for (t[n] = [], o = I = 0; 3 >= I; o = ++I) t[n][o] = s.els[n][o];
            if (0 === t[3][3]) return !1;
            for (n = Y = 0; 3 >= Y; n = ++Y) for (o = j = 0; 3 >= j; o = ++j) t[n][o] /= t[3][3];
            ...
            if (v[0] = d[0].length(), d[0] = d[0].normalize(), b[0] = d[0].dot(d[1]), d[1] = d[1].combine(d[0], 1, -b[0]), v[1] = d[1].length(), d[1] = d[1].normalize(), b[0] /= v[1], b[1] = d[0].dot(d[2]), d[2] = d[2].combine(d[0], 1, -b[1]), b[2] = d[1].dot(d[2]), d[2] = d[2].combine(d[1], 1, -b[2]), v[2] = d[2].length(), d[2] = d[2].normalize(), b[1] /= v[2], b[2] /= v[2], a = d[1].cross(d[2]), d[0].dot(a) < 0) for (n = O = 0; 2 >= O; n = ++O) for (v[n] *= -1, o = V = 0; 2 >= V; o = ++V) d[n].els[o] *= -1;
            g = function (t, e) {
                return d[t].els[e]
            ...
            var t, e, n, r, o;
            for (n = "matrix3d(", t = r = 0; 3 >= r; t = ++r) for (e = o = 0; 3 >= o; e = ++o) n += Z(this.els[t][e], 10), (3 !== t || 3 !== e) && (n += ",");
            return n += ")"
        ...
        for (f = ["Webkit", "Moz", "ms"], a = 0, l = f.length; l > a; a++) if (n = f[a], e = n + i, void 0 !== document.body.style[e]) return n;
        return ""
    }), A = w(function (t) {
        var e;
        ...
        var n, r, o, i, s, a, u, l;
        if (null == e.tStart && (e.tStart = t), i = (t - e.tStart) / e.options.duration, s = e.curve(i), r = {}, i >= 1) r = e.curve.returnsToSelf ? e.properties.start : e.properties.end; else {
        ...
        if (null != r && (d = d.filter(function (t) {
                return t.id !== r
            })), C.stop(t, {timeout: !1}), !n.animated) return C.css(t, e), void("function" == typeof n.complete && n.complete(this));
        ...
        var n;
        return J += 1, n = {id: J, tStart: Date.now(), fn: t, delay: e, originalDelay: e}, P(n), Q.push(n), J
    }, x = function (t) {
        ...
        var e, n, r, o, i, s, a, u, l, f;
        if (E = !t, t) {
            if (L) for (n = Date.now() - K, i = 0, u = m.length; u > i; i++) e = m[i], null != e.tStart && (e.tStart += n);
        ...
        bounciness: 400,
        elasticity: 200
    }, C.easeInOut.defaults = C.easeIn.defaults = C.easeOut.defaults = {friction: 500}, C.css = j(function (t, e) {
        return v(t, e, !0)
